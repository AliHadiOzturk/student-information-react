...
export const Students: Student[] = [
    { id: 3, schoolNumber: '160910112', person: { nationalId: '11111111111', name: 'Jess', surname: 'Chestain' } },
    {
    ...
    { id: 2, schoolNumber: '160910109', person: { nationalId: '33333333333', name: 'Nikola', surname: 'Tesla' } },
]
